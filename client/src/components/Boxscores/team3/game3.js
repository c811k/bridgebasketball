            ...
            <div className="col-md-12">
                <table className="table table-striped">
                    ...
                    <tbody>
                        ...
                        <th scope="row">13</th>
                        <td>Daniel Park</td>
                        <td className="text-right">3-12</td>
                        ...
                        <th scope="row">12</th>
                        <td>Steve Kang</td>
                        <td className="text-right">5-11</td>
                        ...
                        <th scope="row">99</th>
                        <td>Sung Jung</td>
                        <td className="text-right">9-18</td>
                        ...
                        <td></td>
                        <td className="text-right font-weight-bolder">29-63</td>
                        <td className="text-right font-weight-bolder">6-26</td>
                        <td className="text-right font-weight-bolder">5-8</td>
                        ...
                        <td className="text-right font-weight-bolder">72</td>
                        </tr>
                        <tr>
                        <th scope="row"></th>
                        <td></td>
                        <td className="text-right font-weight-bolder">46.0%</td>
                        <td className="text-right font-weight-bolder">34.6%</td>
                        <td className="text-right font-weight-bolder">62.5%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
