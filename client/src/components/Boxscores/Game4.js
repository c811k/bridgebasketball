...
import Home from "./team6/game2";
import Away from "./team2/game2";
...
class Game4 extends React.Component {
    ...
    render() {
        return(
            <div>
                <Button color="link" size="sm" className="rounded-0" outline block onClick={this.toggle}>BOX SCORE</Button>
