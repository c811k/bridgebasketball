            ...
            <div className="col-md-12">
                <table className="table table-striped">
                    ...
                    <tbody>
                        ...
                        <th scope="row">25</th>
                        <td>James Choi</td>
                        <td className="text-right">6-16</td>
                        ...
                        <td></td>
                        <td className="text-right font-weight-bolder">19-41</td>
                        <td className="text-right font-weight-bolder">3-9</td>
                        <td className="text-right font-weight-bolder">7-23</td>
                        ...
                        <td className="text-right font-weight-bolder">48</td>
                        </tr>
                        <tr>
                        <th scope="row"></th>
                        <td></td>
                        <td className="text-right font-weight-bolder">46.3%</td>
                        <td className="text-right font-weight-bolder">33.3%</td>
                        <td className="text-right font-weight-bolder">30.4%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
