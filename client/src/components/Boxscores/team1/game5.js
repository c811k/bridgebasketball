            ...
            <div className="col-md-12">
                <table className="table table-striped">
                    ...
                    <tbody>
                        ...
                        <td className="text-right">6-14</td>
                        ...
                        <td></td>
                        <td className="text-right font-weight-bolder">20-48</td>
                        <td className="text-right font-weight-bolder">3-12</td>
                        <td className="text-right font-weight-bolder">9-18</td>
                        <td className="text-right font-weight-bolder">28</td>
                        ...
                        <td className="text-right font-weight-bolder">17</td>
                        <td className="text-right font-weight-bolder">52</td>
                        </tr>
                        <tr>
                        <th scope="row"></th>
                        <td></td>
                        <td className="text-right font-weight-bolder">41.7%</td>
