                            ...
                            <li className="list-group-item border-0">
                                <div className="row">
                                    <div className="col-md-8">
                                        <h5>Double Up <span className="text-muted small">(1-0)</span></h5>
                                    </div>
                                    <div className="col-md-4 text-right align-bottom">
                                        <h5>57 <i class="fas fa-caret-left"></i></h5>
                                    </div>
                                </div>
                            </li>
                            <li className="list-group-item border-0">
                                <div className="row">
                                    <div className="col-md-6">
                                        <h5 className="text-muted">Fantastic <span className="text-muted small">(0-1)</span></h5>
                                    </div>
                            ...
                            <li className="list-group-item border-0">
                                <div className="row">
                                    <div className="col-md-12 d-flex justify-content-between">
                                        {/* <a id="btn" className="btn btn-sm shadow-sm" href="https://www.youtube.com/watch?v=LMF8_cXSQ28" target="_blank">WATCH</a> */}
                                        <Watch1 />
                            ...
                            <li className="list-group-item border-0">
                                <div className="row">
                                    <div className="col-md-9">
                                        <h5 className="text-muted">Angry Birdz <span className="text-muted small">(0-1)</span></h5>
                                    </div>
                                    <div className="col-md-3 text-right align-bottom">
                                        <h5 className="text-muted">36 <i class="fas fa-caret-left text-white"></i></h5>
                                    </div>
                                </div>
                            </li>
                            <li className="list-group-item border-0">
                                <div className="row">
                                    <div className="col-md-9">
                                        <h5>The Chosen <span className="text-muted small">(1-0)</span></h5>
                                    </div>
                                    <div className="col-md-3 text-right align-bottom">
                                        <h5>39 <i class="fas fa-caret-left"></i></h5>
                                    </div>
                                </div>
                            </li>
                            <li className="list-group-item border-0">
                    ...
                    <div className="card shadow-sm" id="score-card">
                        ...
                        <ul className="list-group flush">
                            <li className="list-group-item border-0">
                                <div className="row">
                                    <div className="col-md-9">
                                        <h5>Lord of the Rims <span className="text-muted small">(1-0)</span></h5>
                                    </div>
                                    <div className="col-md-3 text-right align-bottom">
                                        <h5>53 <i class="fas fa-caret-left"></i></h5>
                                    </div>
                                </div>
                            </li>
                            <li className="list-group-item border-0">
                                <div className="row">
                                    <div className="col-md-9">
                                        <h5 className="text-muted">BH <span className="text-muted small">(0-1)</span></h5>
                                    </div>
                                    <div className="col-md-3 text-right align-bottom">
                                        <h5 className="text-muted">42 <i class="fas fa-caret-left text-white"></i></h5>
                                    </div>
                                </div>
                            </li>
                            <li className="list-group-item border-0">
