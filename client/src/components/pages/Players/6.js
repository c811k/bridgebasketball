                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" 
                                            src="https://scontent-lax3-2.xx.fbcdn.net/v/t31.0-8/18620979_10104950082062694_4279643159036089587_o.jpg?_nc_cat=110&_nc_oc=AQkVCT7oegN9w70RlFEwWH31kkZOeJbdwzwilNgeD00ms2rIXO92iEnQTf430dEE6Vk&_nc_ht=scontent-lax3-2.xx&oh=199a0cd007bf55dd39c7d44b34b80966&oe=5DCF42AA" 
                                            alt="profile" 
                                            id="playerpic" 
                                            onError={(e) => {
                        ...
                        <div className="card shadow-sm">
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" 
                                            src="https://scontent-lax3-2.xx.fbcdn.net/v/t1.0-1/48429518_975461749314890_373469723037270016_n.jpg?_nc_cat=103&_nc_oc=AQmkpgAr472Ql6yWA9cL-X5sqdC-rjnVvCMMX4MjnqtMuykm5i_mEBZjVPAVHKiUJZE&_nc_ht=scontent-lax3-2.xx&oh=7be79d76d2505965d8aa123e4dbe3e7d&oe=5E02D5C4" 
                                            alt="profile" 
                                            id="playerpic"
                                            onError={(e) => {
                                                e.target.onerror = null;
                        ...
                        <div className="card shadow-sm">
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" 
                                            src="https://scontent-lax3-2.xx.fbcdn.net/v/t1.0-9/49069835_10102855054979036_3077497853183000576_o.jpg?_nc_cat=102&_nc_oc=AQn4i0nTgFG3st8NAMuFKn5zK7rD_TXcfuUivWKhUqxRJzEvwuGkRtjkPgFR8CVscIM&_nc_ht=scontent-lax3-2.xx&oh=9231a605941e246644ea52eb5dc2c767&oe=5DFD48BC" 
                                            alt="profile" 
                                            id="playerpic" 
                                            onError={(e) => {
                                                e.target.onerror = null;
                            ...
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12 justify-content-center">
                                        <img className="img-fluid rounded p-2" 
                                            src="https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-9/67392354_2357005947688625_135226139076460544_n.jpg?_nc_cat=101&_nc_oc=AQmhJ7ndAWIC_sp6a0Oyam2nD1KdWW3dyErHq2Rs7lFb-p834bB5cwbT0TFeIbGlCpA&_nc_ht=scontent-lax3-1.xx&oh=ab61d986a60031988917aa522473ff7b&oe=5DD7DBA2" 
                                            alt="profile" 
                                            id="playerpic" 
                                            onError={(e) => {
                                                e.target.onerror = null;
                        ...
                        <div className="card shadow-sm">
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" 
                                            src="https://scontent-lax3-2.xx.fbcdn.net/v/t1.0-9/50956311_377417096368125_6254219827544588288_o.jpg?_nc_cat=111&_nc_oc=AQkLkUf6ijGnz4KrtgeMa-TJEQ8gxxErgE07Npp25xpiK327swHYRjH5MaihpEhQv2Y&_nc_ht=scontent-lax3-2.xx&oh=7aef71982a82edec9a8a271d2f7e8f60&oe=5E04C5DB" 
                                            alt="profile" 
                                            id="playerpic"
                                            onError={(e) => {
                                                e.target.onerror = null;
                        ...
                        <div className="card shadow-sm">
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" 
                                            src="https://scontent-lax3-2.xx.fbcdn.net/v/t1.0-9/56952721_10157018498010011_5065664710154649600_n.jpg?_nc_cat=100&_nc_oc=AQnOf40B76mMUQQ08KjoJBOn4nWkx5eQzp8CA0-LT9GUg36fO_BqQSWbeFCMjx_M5pkQpsU9F5QKkMuISA0jXJMs&_nc_ht=scontent-lax3-2.xx&oh=8954c3617ffbdb629aa088def4fa422c&oe=5E6042E5" 
                                            alt="profile" 
                                            id="playerpic" 
                                            onError={(e) => {
                                                e.target.onerror = null;
                        ...
                        <div className="card shadow-sm">
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" 
                                            src="https://scontent-lax3-2.xx.fbcdn.net/v/t31.0-8/13719620_10210353529858134_8983312615173657508_o.jpg?_nc_cat=103&_nc_oc=AQmYyxBNuW1oeDRUY7SSgTWAiMVs4anfXYn503BYK7bHBBMR3xYthJ2XKrHUk7USWyw&_nc_ht=scontent-lax3-2.xx&oh=513d15eda8ae68520552c77d0d8167f1&oe=5DCEEC6A" 
                                            alt="profile" 
                                            id="playerpic" 
                                            onError={(e) => {
                                                e.target.onerror = null;
