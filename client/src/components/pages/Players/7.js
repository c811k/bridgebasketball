                            ...
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" src="https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-9/35526954_10106171815045031_8711812075799707648_n.jpg?_nc_cat=109&_nc_ht=scontent-lax3-1.xx&oh=43959d9e8a6e1374f96e4ca4091fbe16&oe=5D70C162" alt="profile" id="playerpic" />
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-12 text-center">
                                        ...
                                        <h5 className="badge badge-dark">FA</h5>                                 
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="col-md-12 text-right">
                                        <ul className="list-group list-group">
                                            <li className="list-group-item border-0">
                                                <span className="badge badge-light d-flex justify-content-between align-items-center border-0 small my-1">#?<span>GP - <span className="text-danger">0</span></span></span>
                    ...
                    <div id="playercard">
                        <div className="card shadow-sm">
                            <div className="card-front">
                                <div className="row">
                                    <div className="col-md-12">
                                        <img className="img-fluid rounded p-2" src="https://scontent-lax3-1.xx.fbcdn.net/v/t31.0-1/c379.0.1290.1290a/10506738_10150004552801856_220367501106153455_o.jpg?_nc_cat=1&_nc_ht=scontent-lax3-1.xx&oh=6fca6cd7a91d084ecf961f15474e31e6&oe=5D5FE949" alt="profile" id="playerpic" />
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-12 text-center">
                                        <h6 className="mt-3 pb-2 mx-5 border-bottom">
                                            JOSHUA <span className="text-warning">PYO</span>
                                        </h6>
                                        <h5 className="badge badge-dark">FA</h5>                                 
                                    </div>
                                </div>
                            ...
                            <div className="card-back">
                                ...
                                <div className="row">
                                    <div className="col-md-12 text-right">
                                        <ul className="list-group list-group">
                                            <li className="list-group-item border-0">
                                                <span className="badge badge-light d-flex justify-content-between align-items-center border-0 small my-1">#72<span>GP - <span className="text-danger">0</span></span></span>
                                                <span className="badge badge-warning d-flex justify-content-between align-items-center border-0 small">FG%<span>-</span></span><span className="small">NA</span>
                                                <span className="badge badge-secondary d-flex justify-content-between align-items-center border-0 small">3P%<span>-</span></span><span className="small">NA</span>
                                                <span className="badge badge-warning d-flex justify-content-between align-items-center border-0 small">FT%<span>-</span></span><span className="small">NA</span>
                                                <span className="badge badge-secondary d-flex justify-content-between align-items-center border-0">PPG<span>-</span></span><span className="small">NA</span>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul className="pagination justify-content-center">
                            <li className="page-item">
                                <a className="page-link text-dark border-0" href="/players/6" aria-label="Previous" id="left">
                            ...
                            <li className="page-item disabled">
                                <a className="page-link text-white border-0" href="/players/4" aria-label="Next" id="right">
