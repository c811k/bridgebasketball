...
class Game12 extends React.Component {
    constructor(props) {
        super(props);
        this.state= {
            modal: false
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `75.8%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        30.3%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `93.2%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        23.3%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `85.8%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        50.0%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `79.5%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        35
