                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `63.4%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        33.3%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `71.8%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        25.0%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `96%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        55.6%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `96.4%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        27
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `87.5%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        7
