                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `36.2%` }}></div>
                                        </div>
                                    </div>
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `35.6%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        35.6%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `40.9%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        40.9%
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `25.0%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        25.0%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `50.0%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        50.0%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `7%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        7
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `38%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        38
