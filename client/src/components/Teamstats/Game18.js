                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `94.5%` }}></div>
                                        </div>
                                    </div>
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `43.5%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        33.3%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `54.2%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        26
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `83.3%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        5
