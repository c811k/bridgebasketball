...
class Game8 extends React.Component {
    constructor(props) {
        super(props);
        this.state= {
            modal: false
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-warning" role="progressbar" style={{ width: `72.9%`}}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        31.3%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `85.6%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        57.1%
                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center row">
                                    ...
                                    <div className="col-md-3 nopadding">
                                        <div className="progress flex-fill rounded-pill">
                                            <div className="progress-bar bg-secondary" role="progressbar" style={{ width: `53.8%` }}></div>
                                        </div>
                                    </div>
                                    <div className="col-md-3 text-right">
                                        7
