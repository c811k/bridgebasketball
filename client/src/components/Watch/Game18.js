...
class Game18 extends React.Component {
    constructor(props) {
        super(props);
        this.state= {
            modal: false
                ...
                <ModalBody className="bg-white rounded-lg" id="modal">
                    <div className="container">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mt-3">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/lzbiUPmoIYQ" allowFullScreen title="Game18"></iframe>
                        </div>
                    </div>
                </ModalBody>
